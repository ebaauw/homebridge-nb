...
class NbClient extends homebridgeLib.HttpClient {
  ...
  get address () { return this._params.address }
  ...
  async init () {
    this._params.address = (await dns.lookup(this._params.hostname)).address
    this.host = this._params.address + ':' + this._params.port
